...
def parse_opt():
    ...
    parser.add_argument('--ans_dim', type=int, default=2410,
    ...
    parser.add_argument('--layer-name', type=str, default='classifier.main.3.weight_v',
    ...
    parser.add_argument('--seed', type=int, default=1024,
                        help='seed')
    parser.add_argument('--ntokens', type=int, default=19901,
                        help='ntokens')
